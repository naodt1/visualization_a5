...
export class FramerateCalculator {
    ...
    addFrameRate(frameRate) {
        ...
        this.totalFrameRate += frameRate;

        if (this.frameRates.length > this.windowSize) {
            const removedFrameRate = this.frameRates.shift();
            this.totalFrameRate -= removedFrameRate;
        }
    }
    ...
    getAverageFrameRate() {
      ...
      return this.totalFrameRate / this.frameRates.length;
    }
  }
